...
Preprocessed_fMRI_filepath = './data/rfMRI_REST1_LR_Atlas_MSMAll_hp2000_clean_reconstruction.dtseries.nii';
...
% data_prep.py driver
% system('/opt/homebrew/Caskroom/miniconda/base/envs/rsfMRI-VAE/bin/python ./lib/data_prep.py --fmri-path ./data --trans-path ./result --output-path ./data');
