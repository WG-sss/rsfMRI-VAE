...
# os.system('python Get_data.py --mode encode  --batch-size 120 --resume ./demo/checkpoint/checkpoint.pth.tar')
get_inference(resume_file='./demo/checkpoint/checkpoint.pth.tar')
